...
class GeneralQuizPlayScreen extends ConsumerStatefulWidget {
  const GeneralQuizPlayScreen({super.key});

  @override
  ConsumerState<GeneralQuizPlayScreen> createState() =>
      _GeneralQuizPlayScreenState();
}

class _GeneralQuizPlayScreenState extends ConsumerState<GeneralQuizPlayScreen>
  ...
  void _onAnswerTapped(String option) {
    final session = ref.read(generalQuizProvider).value;
    ...
    ref.read(generalQuizProvider.notifier).submitAnswer(option);
  ...
  void _onNext() {
    ...
    ref.read(generalQuizProvider.notifier).nextQuestion();
  }
  ...
  void _onRestart() {
    ...
    ref.read(generalQuizProvider.notifier).restart();
  }
  ...
  Widget build(BuildContext context) {
    final sessionAsync = ref.watch(generalQuizProvider);
    final victoryTitle = context.l10n.generalQuizVictoryTitle;
    final shareLabel = context.l10n.generalQuizShareLabel;

    ref.listen<AsyncValue<QuizSessionState>>(generalQuizProvider, (prev, next) {
              ...
              return Stack(
                ...
                children: [
                  ...
                  if (session.isGameOver)
                    GameOverOverlay(
                      key: const ValueKey('gq-gameover'),
                      session: session,
                    ...
                    if (coPlayMode && !showAnswerChoices) ...[
                      Padding(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: Text(context.l10n.generalQuizRevealChoices),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(emoji, style: TextStyle(fontSize: compact ? 48 : 64)),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ElevatedButton.icon(
        ...
        label: Text(context.l10n.generalQuizNextQuestion),
        style: ElevatedButton.styleFrom(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(context.l10n.generalQuizLoading, style: AppTextStyles.bodyLarge),
        ],
      ),
    );
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              context.l10n.generalQuizLoadFailed,
