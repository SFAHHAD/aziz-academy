...
class CapitalsQuizScreen extends ConsumerStatefulWidget {
...
class _QuizHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // hearts on the left (end) — exactly what the user expects for Arabic.
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Row(
              children: [
                // Back button — arrow direction follows text direction
                Semantics(
    ...
    return Semantics(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: AppColors.capitalsColor.withAlpha(20),
    ...
    return Semantics(
      ...
      child: TweenAnimationBuilder<double>(
        ...
        builder: (context, value, _) => LinearProgressIndicator(
          ...
          valueColor: const AlwaysStoppedAnimation(AppColors.capitalsColor),
...
// =============================================================================
// Answer card — individual option with shake / bounce animations
// =============================================================================
...
class _AnswerCardState extends State<_AnswerCard>
  ...
  Color get _borderColor {
    if (!widget.isRevealed) return AppColors.capitalsColor.withAlpha(100);
...
// =============================================================================
// Flag image widget — loads from flagcdn.com with shimmer + error fallback
// =============================================================================
